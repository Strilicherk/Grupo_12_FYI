...
{
    class BuscarPorIdTurmaCommand : Notifiable<Notification>, ICommand
    {
        public BuscarPorIdTurmaCommand()
        {

        }
        public BuscarPorIdTurmaCommand(string nomeTurma, DateTime dataInicio, DateTime dataFim, string publicoAlvo, string descricao, string preRequisito, int quantidadeAluno, int qtdMax)
        {
            NomeTurma = nomeTurma;
