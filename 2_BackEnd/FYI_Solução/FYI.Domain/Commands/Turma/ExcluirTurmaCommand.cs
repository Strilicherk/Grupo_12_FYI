...
namespace FYI.Domain.Commands.Turma
{
    ...
    {
        public ExcluirTurmaCommand()
        {

        }
        public ExcluirTurmaCommand(string nomeTurma, DateTime dataInicio, DateTime dataFim, string publicoAlvo, string descricao, string preRequisito, int quantidadeAluno, int qtdMax)
        {
            NomeTurma = nomeTurma;
